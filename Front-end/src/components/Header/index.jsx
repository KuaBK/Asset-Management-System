...
const Header = () => {
    return (
        <div className='h-[15vh] bg-[#fdfdfd] flex justify-between px-[30px] py-[10px] ' >
            <div className='flex'>
                <img src={logo} alt="" />
                <div className='w-[200px] font-[600] text-[25px] text-[rgb(0,185,219)] '>Asset Management System</div>
            </div>
